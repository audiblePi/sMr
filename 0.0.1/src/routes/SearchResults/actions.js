...
export const SEARCH_RESULTS_FETCH_MOVIES_DONE = "SEARCH_RESULTS_FETCH_MOVIES_DONE";
export const SEARCH_RESULTS_FETCH_FAILED = "SEARCH_RESULTS_FETCH_FAILED";
...
export function fetchMoviesDone(status, data){
	return {
		type: SEARCH_RESULTS_FETCH_MOVIES_DONE,
		fetched: true,
		fetching: false,
		data: data
	}
...
export function fetchFailed(error){
	return {
		type: SEARCH_RESULTS_FETCH_FAILED,
		fetched: false,
		fetching: false
	}
}
